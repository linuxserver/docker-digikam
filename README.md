...
<!-- Please read https://github.com/linuxserver/docker-digikam/blob/master/.github/CONTRIBUTING.md -->
...
[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fdigikam?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
...
-e INSTALL_PACKAGES=noto-fonts-cjk-e LC_ALL=zh_CN.UTF-8
```
